...
//#endif
//		NSString *filepath = [saveDirectory stringByAppendingPathComponent:@"dict.sql"];
//		
...
//			[[NSFileManager defaultManager] copyItemAtPath:[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"dict.sql"]
//													toPath:databaseFilepath error:nil];
//		}
//	}
